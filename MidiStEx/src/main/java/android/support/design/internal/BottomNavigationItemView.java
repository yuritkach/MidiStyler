...
public class BottomNavigationItemView extends FrameLayout implements MenuView.ItemView {
    ...
    public BottomNavigationItemView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        int inactiveLabelSize = res.getDimensionPixelSize(C0007R.dimen.design_bottom_navigation_text_size);
        int activeLabelSize = res.getDimensionPixelSize(C0007R.dimen.design_bottom_navigation_active_text_size);
        this.mDefaultMargin = res.getDimensionPixelSize(C0007R.dimen.design_bottom_navigation_margin);
        ...
        LayoutInflater.from(context).inflate(C0007R.layout.design_bottom_navigation_item, this, true);
        setBackgroundResource(C0007R.C0008drawable.design_bottom_navigation_item_background);
        this.mIcon = (ImageView) findViewById(C0007R.C0009id.icon);
        this.mSmallLabel = (TextView) findViewById(C0007R.C0009id.smallLabel);
        this.mLargeLabel = (TextView) findViewById(C0007R.C0009id.largeLabel);
    }
