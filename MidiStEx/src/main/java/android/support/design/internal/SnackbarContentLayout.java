...
public class SnackbarContentLayout extends LinearLayout implements BaseTransientBottomBar.ContentViewCallback {
    ...
    public SnackbarContentLayout(Context context, AttributeSet attrs) {
        ...
        this.mMaxWidth = a.getDimensionPixelSize(C0007R.styleable.SnackbarLayout_android_maxWidth, -1);
        this.mMaxInlineActionWidth = a.getDimensionPixelSize(C0007R.styleable.SnackbarLayout_maxActionInlineWidth, -1);
        a.recycle();
    }
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int multiLineVPadding = getResources().getDimensionPixelSize(C0007R.dimen.design_snackbar_padding_vertical_2lines);
        int singleLineVPadding = getResources().getDimensionPixelSize(C0007R.dimen.design_snackbar_padding_vertical);
