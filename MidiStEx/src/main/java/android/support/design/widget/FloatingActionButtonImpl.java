...
class FloatingActionButtonImpl {
    ...
    public CircularBorderDrawable createBorderDrawable(int borderWidth, ColorStateList backgroundTint) {
        ...
        borderDrawable.setGradientColors(ContextCompat.getColor(context, C0007R.color.design_fab_stroke_top_outer_color), ContextCompat.getColor(context, C0007R.color.design_fab_stroke_top_inner_color), ContextCompat.getColor(context, C0007R.color.design_fab_stroke_end_inner_color), ContextCompat.getColor(context, C0007R.color.design_fab_stroke_end_outer_color));
