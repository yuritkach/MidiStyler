...
public class FloatingActionButton extends VisibilityAwareImageButton {
    ...
    public FloatingActionButton(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mBackgroundTintMode = ViewUtils.parseTintMode(a.getInt(C0007R.styleable.FloatingActionButton_backgroundTintMode, -1), (PorterDuff.Mode) null);
        this.mRippleColor = a.getColor(C0007R.styleable.FloatingActionButton_rippleColor, 0);
        this.mSize = a.getInt(C0007R.styleable.FloatingActionButton_fabSize, -1);
    ...
    public static class Behavior extends CoordinatorLayout.Behavior<FloatingActionButton> {
        ...
        public Behavior(Context context, AttributeSet attrs) {
            ...
            this.mAutoHideEnabled = a.getBoolean(C0007R.styleable.FloatingActionButton_Behavior_Layout_behavior_autoHide, true);
            a.recycle();
        }
