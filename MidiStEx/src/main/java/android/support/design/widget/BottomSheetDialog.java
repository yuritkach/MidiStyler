...
public class BottomSheetDialog extends AppCompatDialog {
    ...
    private View wrapInBottomSheet(int layoutResId, View view, ViewGroup.LayoutParams params) {
        FrameLayout container = (FrameLayout) View.inflate(getContext(), C0007R.layout.design_bottom_sheet_dialog, (ViewGroup) null);
        CoordinatorLayout coordinator = (CoordinatorLayout) container.findViewById(C0007R.C0009id.coordinator);
        if (layoutResId != 0 && view == null) {
            view = getLayoutInflater().inflate(layoutResId, coordinator, false);
        }
        FrameLayout bottomSheet = (FrameLayout) coordinator.findViewById(C0007R.C0009id.design_bottom_sheet);
        ...
        coordinator.findViewById(C0007R.C0009id.touch_outside).setOnClickListener(new View.OnClickListener() {
    ...
    private static int getThemeResId(Context context, int themeId) {
        ...
        if (context.getTheme().resolveAttribute(C0007R.attr.bottomSheetDialogTheme, outValue, true)) {
