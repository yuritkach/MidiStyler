...
public abstract class BaseTransientBottomBar<B extends BaseTransientBottomBar<B>> {
    ...
    protected BaseTransientBottomBar(@NonNull ViewGroup parent, @NonNull View content, @NonNull ContentViewCallback contentViewCallback) {
        if (parent == null) {
            ...
            this.mView = (SnackbarBaseLayout) LayoutInflater.from(this.mContext).inflate(C0007R.layout.design_layout_snackbar, this.mTargetParent, false);
    ...
    public void animateViewIn() {
        ...
        Animation anim = AnimationUtils.loadAnimation(this.mView.getContext(), C0007R.anim.design_snackbar_in);
    ...
    private void animateViewOut(final int event) {
        ...
        Animation anim = AnimationUtils.loadAnimation(this.mView.getContext(), C0007R.anim.design_snackbar_out);
        anim.setInterpolator(AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR);
        anim.setDuration(250);
        anim.setAnimationListener(new Animation.AnimationListener() {
            public void onAnimationEnd(Animation animation) {
    ...
    static class SnackbarBaseLayout extends FrameLayout {
        ...
        SnackbarBaseLayout(Context context, AttributeSet attrs) {
            super(context, attrs);
            TypedArray a = context.obtainStyledAttributes(attrs, C0007R.styleable.SnackbarLayout);
            if (a.hasValue(C0007R.styleable.SnackbarLayout_elevation)) {
                ViewCompat.setElevation(this, (float) a.getDimensionPixelSize(C0007R.styleable.SnackbarLayout_elevation, 0));
            }
            a.recycle();
            setClickable(true);
        }
