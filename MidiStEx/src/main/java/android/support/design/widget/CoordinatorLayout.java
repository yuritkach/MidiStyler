...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent2 {
    ...
    public CoordinatorLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0007R.styleable.CoordinatorLayout, defStyleAttr, C0007R.style.Widget_Design_CoordinatorLayout);
        int keylineArrayRes = a.getResourceId(C0007R.styleable.CoordinatorLayout_keylines, 0);
        ...
        this.mStatusBarBackground = a.getDrawable(C0007R.styleable.CoordinatorLayout_statusBarBackground);
        a.recycle();
        setupForInsets();
    ...
    private void getDesiredAnchoredChildRectWithoutConstraints(View child, int layoutDirection, Rect anchorRect, Rect out, LayoutParams lp, int childWidth, int childHeight) {
        ...
        int vgrav = absGravity & C0515R.styleable.AppCompatTheme_seekBarStyle;
        int anchorHgrav = absAnchorGravity & 7;
        int anchorVgrav = absAnchorGravity & C0515R.styleable.AppCompatTheme_seekBarStyle;
        switch (anchorHgrav) {
            case 1:
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (type != 0 || child.getVisibility() != 8) {
                ...
                if (lp.insetEdge != 0 && !drawRect.isEmpty()) {
                    ...
                    switch (absInsetEdge & C0515R.styleable.AppCompatTheme_seekBarStyle) {
    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
        ...
        LayoutParams(Context context, AttributeSet attrs) {
            super(context, attrs);
            TypedArray a = context.obtainStyledAttributes(attrs, C0007R.styleable.CoordinatorLayout_Layout);
            this.gravity = a.getInteger(C0007R.styleable.CoordinatorLayout_Layout_android_layout_gravity, 0);
            this.mAnchorId = a.getResourceId(C0007R.styleable.CoordinatorLayout_Layout_layout_anchor, -1);
            this.anchorGravity = a.getInteger(C0007R.styleable.CoordinatorLayout_Layout_layout_anchorGravity, 0);
            this.keyline = a.getInteger(C0007R.styleable.CoordinatorLayout_Layout_layout_keyline, -1);
            this.insetEdge = a.getInt(C0007R.styleable.CoordinatorLayout_Layout_layout_insetEdge, 0);
            this.dodgeInsetEdges = a.getInt(C0007R.styleable.CoordinatorLayout_Layout_layout_dodgeInsetEdges, 0);
            this.mBehaviorResolved = a.hasValue(C0007R.styleable.CoordinatorLayout_Layout_layout_behavior);
            if (this.mBehaviorResolved) {
                this.mBehavior = CoordinatorLayout.parseBehavior(context, attrs, a.getString(C0007R.styleable.CoordinatorLayout_Layout_layout_behavior));
            }
            a.recycle();
