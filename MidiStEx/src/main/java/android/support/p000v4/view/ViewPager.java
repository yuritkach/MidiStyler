...
public class ViewPager extends ViewGroup {
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (!(child.getVisibility() == 8 || (lp2 = (LayoutParams) child.getLayoutParams()) == null || !lp2.isDecor)) {
                ...
                int vgrav = lp2.gravity & C0515R.styleable.AppCompatTheme_seekBarStyle;
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (child.getVisibility() != 8) {
                ...
                if (lp.isDecor) {
                    ...
                    int vgrav = lp.gravity & C0515R.styleable.AppCompatTheme_seekBarStyle;
                    switch (hgrav) {
                        case 1:
    ...
    public boolean executeKeyEvent(@NonNull KeyEvent event) {
        ...
        switch (event.getKeyCode()) {
            ...
            case C0515R.styleable.AppCompatTheme_popupMenuStyle /*61*/:
