...
import android.support.mediacompat.C0071R;
...
public class NotificationCompat {
    ...
    public static class MediaStyle extends NotificationCompat.Style {
        ...
        public RemoteViews generateContentView() {
            ...
            view.removeAllViews(C0071R.C0073id.media_actions);
            if (numActionsInCompact > 0) {
                for (int i = 0; i < numActionsInCompact; i++) {
                    ...
                    view.addView(C0071R.C0073id.media_actions, generateMediaActionButton(this.mBuilder.mActions.get(this.mActionsToShowInCompact[i])));
                }
            }
            if (this.mShowCancelButton) {
                view.setViewVisibility(C0071R.C0073id.end_padder, 8);
                view.setViewVisibility(C0071R.C0073id.cancel_action, 0);
                view.setOnClickPendingIntent(C0071R.C0073id.cancel_action, this.mCancelButtonIntent);
                view.setInt(C0071R.C0073id.cancel_action, "setAlpha", this.mBuilder.mContext.getResources().getInteger(C0071R.integer.cancel_button_image_alpha));
            } else {
                view.setViewVisibility(C0071R.C0073id.end_padder, 0);
                view.setViewVisibility(C0071R.C0073id.cancel_action, 8);
            }
            return view;
        }
        ...
        private RemoteViews generateMediaActionButton(NotificationCompat.Action action) {
            ...
            RemoteViews button = new RemoteViews(this.mBuilder.mContext.getPackageName(), C0071R.layout.notification_media_action);
            button.setImageViewResource(C0071R.C0073id.action0, action.getIcon());
            if (!tombstone) {
                button.setOnClickPendingIntent(C0071R.C0073id.action0, action.getActionIntent());
            }
            if (Build.VERSION.SDK_INT >= 15) {
                button.setContentDescription(C0071R.C0073id.action0, action.getTitle());
            }
            return button;
        }
        ...
        public int getContentViewLayoutResource() {
            return C0071R.layout.notification_template_media;
        }
        ...
        public RemoteViews generateBigContentView() {
            ...
            big.removeAllViews(C0071R.C0073id.media_actions);
            if (actionCount > 0) {
                for (int i = 0; i < actionCount; i++) {
                    big.addView(C0071R.C0073id.media_actions, generateMediaActionButton(this.mBuilder.mActions.get(i)));
                }
            }
            if (this.mShowCancelButton) {
                big.setViewVisibility(C0071R.C0073id.cancel_action, 0);
                big.setInt(C0071R.C0073id.cancel_action, "setAlpha", this.mBuilder.mContext.getResources().getInteger(C0071R.integer.cancel_button_image_alpha));
                big.setOnClickPendingIntent(C0071R.C0073id.cancel_action, this.mCancelButtonIntent);
            } else {
                big.setViewVisibility(C0071R.C0073id.cancel_action, 8);
            }
            return big;
        }
        ...
        public int getBigContentViewLayoutResource(int actionCount) {
            return actionCount <= 3 ? C0071R.layout.notification_template_big_media_narrow : C0071R.layout.notification_template_big_media;
        }
    }
    ...
    public static class DecoratedMediaCustomViewStyle extends MediaStyle {
        ...
        public int getContentViewLayoutResource() {
            if (this.mBuilder.getContentView() != null) {
                return C0071R.layout.notification_template_media_custom;
            }
        ...
        /* access modifiers changed from: package-private */
        public int getBigContentViewLayoutResource(int actionCount) {
            return actionCount <= 3 ? C0071R.layout.notification_template_big_media_narrow_custom : C0071R.layout.notification_template_big_media_custom;
        }
        ...
        private void setBackgroundColor(RemoteViews views) {
            ...
            if (this.mBuilder.getColor() != 0) {
                ...
                color = this.mBuilder.mContext.getResources().getColor(C0071R.color.notification_material_background_media_default_color);
            }
            views.setInt(C0071R.C0073id.status_bar_latest_event_content, "setBackgroundColor", color);
        }
    }
}
