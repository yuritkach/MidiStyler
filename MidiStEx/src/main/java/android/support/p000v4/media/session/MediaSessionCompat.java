    ...
    public static abstract class Callback {
        ...
        public boolean onMediaButtonEvent(Intent mediaButtonEvent) {
            ...
            switch (keyEvent.getKeyCode()) {
                case C0515R.styleable.AppCompatTheme_textAppearanceListItemSmall /*79*/:
                case C0515R.styleable.AppCompatTheme_colorPrimaryDark /*85*/:
                ...
                if (ke != null && ke.getAction() == 0) {
                    ...
                    switch (ke.getKeyCode()) {
                        ...
                        case C0515R.styleable.AppCompatTheme_colorAccent /*86*/:
                            ...
                            return;
                        case C0515R.styleable.AppCompatTheme_colorControlNormal /*87*/:
                            if ((32 & validActions) != 0) {
                                cb.onSkipToNext();
                                return;
                            }
                            return;
                        case C0515R.styleable.AppCompatTheme_colorControlActivated /*88*/:
                            if ((16 & validActions) != 0) {
                                cb.onSkipToPrevious();
                                return;
                            }
                            return;
                        case C0515R.styleable.AppCompatTheme_colorControlHighlight /*89*/:
                            if ((8 & validActions) != 0) {
                                cb.onRewind();
                                return;
                            }
        ...
        public RemoteControlClient.MetadataEditor buildRccMetadata(Bundle metadata) {
            ...
            if (metadata != null) {
                ...
                if (metadata.containsKey(MediaMetadataCompat.METADATA_KEY_RATING)) {
                    editor.putObject(C0515R.styleable.AppCompatTheme_buttonBarNeutralButtonStyle, metadata.getParcelable(MediaMetadataCompat.METADATA_KEY_RATING));
                }
