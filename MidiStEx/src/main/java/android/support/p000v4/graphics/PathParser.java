...
public class PathParser {
    ...
    private static void extract(String s, int start, ExtractFloatResult result) {
        ...
        for (int currentIndex = start; currentIndex < s.length(); currentIndex++) {
            ...
            switch (s.charAt(currentIndex)) {
                ...
                case C0515R.styleable.AppCompatTheme_searchViewStyle /*69*/:
                case C0515R.styleable.AppCompatTheme_buttonBarNeutralButtonStyle /*101*/:
                    isExponential = true;
                    break;
            }
            if (foundSeparator) {
    ...
    public static class PathDataNode {
        ...
        private static void addCommand(Path path, float[] current, char previousCmd, char cmd, float[] val) {
            ...
            switch (cmd) {
                case C0515R.styleable.AppCompatTheme_imageButtonStyle /*65*/:
                case C0515R.styleable.AppCompatTheme_alertDialogTheme /*97*/:
                    incr = 7;
                    break;
                case C0515R.styleable.AppCompatTheme_textAppearanceSearchResultSubtitle /*67*/:
                case C0515R.styleable.AppCompatTheme_buttonBarPositiveButtonStyle /*99*/:
                    incr = 6;
                    break;
                case C0515R.styleable.AppCompatTheme_listPreferredItemHeightLarge /*72*/:
                case C0515R.styleable.AppCompatTheme_colorAccent /*86*/:
                case C0515R.styleable.AppCompatTheme_buttonStyleSmall /*104*/:
                case C0515R.styleable.AppCompatTheme_colorError /*118*/:
                    incr = 1;
                    break;
                case C0515R.styleable.AppCompatTheme_listPopupWindowStyle /*76*/:
                case C0515R.styleable.AppCompatTheme_textAppearanceListItem /*77*/:
                case C0515R.styleable.AppCompatTheme_colorPrimary /*84*/:
                case 'l':
                case 'm':
                case C0515R.styleable.AppCompatTheme_tooltipFrameBackground /*116*/:
                    incr = 2;
                    break;
                case C0515R.styleable.AppCompatTheme_panelMenuListWidth /*81*/:
                case C0515R.styleable.AppCompatTheme_listChoiceBackgroundIndicator /*83*/:
                case C0515R.styleable.AppCompatTheme_spinnerStyle /*113*/:
                case C0515R.styleable.AppCompatTheme_listMenuViewStyle /*115*/:
                    incr = 4;
                    break;
                case C0515R.styleable.AppCompatTheme_colorButtonNormal /*90*/:
                case 'z':
                    path.close();
