...
public class ListMenuItemView extends LinearLayout implements MenuView.ItemView {
    ...
    public ListMenuItemView(Context context, AttributeSet attrs) {
        this(context, attrs, C0312R.attr.listMenuViewStyle);
    }

    public ListMenuItemView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs);
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(getContext(), attrs, C0312R.styleable.MenuView, defStyleAttr, 0);
        this.mBackground = a.getDrawable(C0312R.styleable.MenuView_android_itemBackground);
        this.mTextAppearance = a.getResourceId(C0312R.styleable.MenuView_android_itemTextAppearance, -1);
        this.mPreserveIconSpacing = a.getBoolean(C0312R.styleable.MenuView_preserveIconSpacing, false);
        this.mTextAppearanceContext = context;
        this.mSubMenuArrow = a.getDrawable(C0312R.styleable.MenuView_subMenuArrow);
        a.recycle();
    }
    ...
    public void onFinishInflate() {
        ...
        this.mTitleView = (TextView) findViewById(C0312R.C0314id.title);
        if (this.mTextAppearance != -1) {
            this.mTitleView.setTextAppearance(this.mTextAppearanceContext, this.mTextAppearance);
        }
        this.mShortcutView = (TextView) findViewById(C0312R.C0314id.shortcut);
        this.mSubMenuArrowView = (ImageView) findViewById(C0312R.C0314id.submenuarrow);
    ...
    private void insertIconView() {
        this.mIconView = (ImageView) getInflater().inflate(C0312R.layout.abc_list_menu_item_icon, this, false);
        addView(this.mIconView, 0);
    }

    private void insertRadioButton() {
        this.mRadioButton = (RadioButton) getInflater().inflate(C0312R.layout.abc_list_menu_item_radio, this, false);
        addView(this.mRadioButton);
    }

    private void insertCheckBox() {
        this.mCheckBox = (CheckBox) getInflater().inflate(C0312R.layout.abc_list_menu_item_checkbox, this, false);
