...
class ViewBoundsCheck {
    ...
    /* renamed from: GT */
    static final int f23GT = 1;

    /* renamed from: LT */
    static final int f24LT = 4;
    ...
    static class BoundFlags {
        ...
        public boolean boundsMatch() {
            ...
            if ((this.mBoundFlags & C0515R.styleable.AppCompatTheme_seekBarStyle) != 0 && (this.mBoundFlags & (compare(this.mChildStart, this.mRvEnd) << 4)) == 0) {
                return false;
            }
