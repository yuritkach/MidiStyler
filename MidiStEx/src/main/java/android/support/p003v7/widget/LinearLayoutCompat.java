...
public class LinearLayoutCompat extends ViewGroup {
    ...
    public LinearLayoutCompat(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0312R.styleable.LinearLayoutCompat, defStyleAttr, 0);
        int index = a.getInt(C0312R.styleable.LinearLayoutCompat_android_orientation, -1);
        if (index >= 0) {
            setOrientation(index);
        }
        int index2 = a.getInt(C0312R.styleable.LinearLayoutCompat_android_gravity, -1);
        if (index2 >= 0) {
            setGravity(index2);
        }
        boolean baselineAligned = a.getBoolean(C0312R.styleable.LinearLayoutCompat_android_baselineAligned, true);
        if (!baselineAligned) {
            setBaselineAligned(baselineAligned);
        }
        this.mWeightSum = a.getFloat(C0312R.styleable.LinearLayoutCompat_android_weightSum, -1.0f);
        this.mBaselineAlignedChildIndex = a.getInt(C0312R.styleable.LinearLayoutCompat_android_baselineAlignedChildIndex, -1);
        this.mUseLargestChild = a.getBoolean(C0312R.styleable.LinearLayoutCompat_measureWithLargestChild, false);
        setDividerDrawable(a.getDrawable(C0312R.styleable.LinearLayoutCompat_divider));
        this.mShowDividers = a.getInt(C0312R.styleable.LinearLayoutCompat_showDividers, 0);
        this.mDividerPadding = a.getDimensionPixelSize(C0312R.styleable.LinearLayoutCompat_dividerPadding, 0);
        a.recycle();
    }
    ...
    public int getBaseline() {
        ...
        if (childBaseline != -1) {
            ...
            if (this.mOrientation == 1 && (majorGravity = this.mGravity & C0515R.styleable.AppCompatTheme_seekBarStyle) != 48) {
                switch (majorGravity) {
                    case 16:
        ...
        while (i3 < count) {
            ...
            if (child == null) {
                ...
                if (baselineAligned && (childBaseline2 = child.getBaseline()) != -1) {
                    ...
                    int index = (((i2 & C0515R.styleable.AppCompatTheme_seekBarStyle) >> 4) & -2) >> 1;
            ...
            for (int i5 = 0; i5 < count; i5++) {
                ...
                if (!(child3 == null || child3.getVisibility() == 8)) {
                    ...
                    if (baselineAligned && (childBaseline = child3.getBaseline()) != -1) {
                        ...
                        int index2 = (((i & C0515R.styleable.AppCompatTheme_seekBarStyle) >> 4) & -2) >> 1;
    ...
    public void layoutVertical(int left, int top, int right, int bottom) {
        ...
        int count = getVirtualChildCount();
        int majorGravity = this.mGravity & C0515R.styleable.AppCompatTheme_seekBarStyle;
    ...
    public void layoutHorizontal(int left, int top, int right, int bottom) {
        ...
        int minorGravity = this.mGravity & C0515R.styleable.AppCompatTheme_seekBarStyle;
        boolean baselineAligned = this.mBaselineAligned;
        int[] maxAscent = this.mMaxAscent;
        int[] maxDescent = this.mMaxDescent;
        ...
        while (i < count) {
            ...
            if (child == null) {
                ...
                switch (gravity & C0515R.styleable.AppCompatTheme_seekBarStyle) {
                    case 16:
    ...
    public void setGravity(int gravity) {
        if (this.mGravity != gravity) {
            ...
            if ((gravity & C0515R.styleable.AppCompatTheme_seekBarStyle) == 0) {
                gravity |= 48;
            }
    ...
    public void setVerticalGravity(int verticalGravity) {
        int gravity = verticalGravity & C0515R.styleable.AppCompatTheme_seekBarStyle;
        if ((this.mGravity & C0515R.styleable.AppCompatTheme_seekBarStyle) != gravity) {
    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
        ...
        public LayoutParams(Context c, AttributeSet attrs) {
            super(c, attrs);
            this.gravity = -1;
            TypedArray a = c.obtainStyledAttributes(attrs, C0312R.styleable.LinearLayoutCompat_Layout);
            this.weight = a.getFloat(C0312R.styleable.LinearLayoutCompat_Layout_android_layout_weight, 0.0f);
            this.gravity = a.getInt(C0312R.styleable.LinearLayoutCompat_Layout_android_layout_gravity, -1);
            a.recycle();
        }
