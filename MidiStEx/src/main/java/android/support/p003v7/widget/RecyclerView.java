...
import android.support.p003v7.recyclerview.C0316R;
...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2 {
    ...
    public RecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        if (attrs != null) {
            TypedArray a2 = context.obtainStyledAttributes(attrs, C0316R.styleable.RecyclerView, defStyle, 0);
            String layoutManagerName = a2.getString(C0316R.styleable.RecyclerView_layoutManager);
            if (a2.getInt(C0316R.styleable.RecyclerView_android_descendantFocusability, -1) == -1) {
                setDescendantFocusability(262144);
            }
            this.mEnableFastScroller = a2.getBoolean(C0316R.styleable.RecyclerView_fastScrollEnabled, false);
            if (this.mEnableFastScroller) {
                initFastScroller((StateListDrawable) a2.getDrawable(C0316R.styleable.RecyclerView_fastScrollVerticalThumbDrawable), a2.getDrawable(C0316R.styleable.RecyclerView_fastScrollVerticalTrackDrawable), (StateListDrawable) a2.getDrawable(C0316R.styleable.RecyclerView_fastScrollHorizontalThumbDrawable), a2.getDrawable(C0316R.styleable.RecyclerView_fastScrollHorizontalTrackDrawable));
            }
            a2.recycle();
    ...
    private boolean isPreferredNextFocus(View focused, View next, int direction) {
        ...
        switch (direction) {
            ...
            case 33:
                ...
                return true;
            case C0515R.styleable.AppCompatTheme_textAppearanceSearchResultTitle /*66*/:
                if (rightness <= 0) {
                    return false;
                }
                return true;
    ...
    public static abstract class LayoutManager {
        ...
        public static Properties getProperties(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
            ...
            TypedArray a = context.obtainStyledAttributes(attrs, C0316R.styleable.RecyclerView, defStyleAttr, defStyleRes);
            properties.orientation = a.getInt(C0316R.styleable.RecyclerView_android_orientation, 1);
            properties.spanCount = a.getInt(C0316R.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = a.getBoolean(C0316R.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = a.getBoolean(C0316R.styleable.RecyclerView_stackFromEnd, false);
            a.recycle();
            return properties;
        }
    ...
    public void initFastScroller(StateListDrawable verticalThumbDrawable, Drawable verticalTrackDrawable, StateListDrawable horizontalThumbDrawable, Drawable horizontalTrackDrawable) {
        ...
        new FastScroller(this, verticalThumbDrawable, verticalTrackDrawable, horizontalThumbDrawable, horizontalTrackDrawable, resources.getDimensionPixelSize(C0316R.dimen.fastscroll_default_thickness), resources.getDimensionPixelSize(C0316R.dimen.fastscroll_minimum_range), resources.getDimensionPixelOffset(C0316R.dimen.fastscroll_margin));
    }
