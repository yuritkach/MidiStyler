...
public class AlertDialogLayout extends LinearLayoutCompat {
    ...
    private boolean tryOnMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (child.getVisibility() != 8) {
                int id = child.getId();
                if (id == C0312R.C0314id.topPanel) {
                    topPanel = child;
                } else if (id == C0312R.C0314id.buttonPanel) {
                    buttonPanel = child;
                } else if ((id != C0312R.C0314id.contentPanel && id != C0312R.C0314id.customPanel) || middlePanel != null) {
                    return false;
                } else {
                    middlePanel = child;
                }
    ...
    public void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        int majorGravity = gravity & C0515R.styleable.AppCompatTheme_seekBarStyle;
