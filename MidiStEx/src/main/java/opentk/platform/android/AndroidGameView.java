...
public class AndroidGameView extends GameViewBase implements IGCUserPeer, SurfaceHolder.Callback {
    ...
    static {
        Runtime.register("OpenTK.Platform.Android.AndroidGameView, OpenTK", AndroidGameView.class, __md_methods);
    }

    public AndroidGameView(Context context) {
        super(context);
        if (getClass() == AndroidGameView.class) {
            TypeManager.Activate("OpenTK.Platform.Android.AndroidGameView, OpenTK", "Android.Content.Context, Mono.Android", this, new Object[]{context});
        }
    }
    ...
    public AndroidGameView(Context context, AttributeSet attributeSet) {
        ...
        if (getClass() == AndroidGameView.class) {
            TypeManager.Activate("OpenTK.Platform.Android.AndroidGameView, OpenTK", "Android.Content.Context, Mono.Android:Android.Util.IAttributeSet, Mono.Android", this, new Object[]{context, attributeSet});
        }
    }
    ...
    public AndroidGameView(Context context, AttributeSet attributeSet, int i) {
        ...
        if (getClass() == AndroidGameView.class) {
            TypeManager.Activate("OpenTK.Platform.Android.AndroidGameView, OpenTK", "Android.Content.Context, Mono.Android:Android.Util.IAttributeSet, Mono.Android:System.Int32, mscorlib", this, new Object[]{context, attributeSet, Integer.valueOf(i)});
        }
    }
    ...
    public AndroidGameView(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        if (getClass() == AndroidGameView.class) {
            TypeManager.Activate("OpenTK.Platform.Android.AndroidGameView, OpenTK", "Android.Content.Context, Mono.Android:Android.Util.IAttributeSet, Mono.Android:System.Int32, mscorlib:System.Int32, mscorlib", this, new Object[]{context, attributeSet, Integer.valueOf(i), Integer.valueOf(i2)});
        }
    }
