...
public class DialogInterface_OnMultiChoiceClickListenerImplementor implements IGCUserPeer, DialogInterface.OnMultiChoiceClickListener {
    ...
    static {
        Runtime.register("Android.Content.IDialogInterfaceOnMultiChoiceClickListenerImplementor, Mono.Android", DialogInterface_OnMultiChoiceClickListenerImplementor.class, __md_methods);
    }
