...
public class SlidingPaneLayout_PanelSlideListenerImplementor implements IGCUserPeer, SlidingPaneLayout.PanelSlideListener {
    ...
    static {
        Runtime.register("Android.Support.V4.Widget.SlidingPaneLayout+IPanelSlideListenerImplementor, Xamarin.Android.Support.Core.UI", SlidingPaneLayout_PanelSlideListenerImplementor.class, __md_methods);
    }
