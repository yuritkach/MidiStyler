...
/* renamed from: mono.android.support.v7.widget.RecyclerView_OnItemTouchListenerImplementor */
public class RecyclerView_OnItemTouchListenerImplementor implements IGCUserPeer, RecyclerView.OnItemTouchListener {
    ...
    static {
        Runtime.register("Android.Support.V7.Widget.RecyclerView+IOnItemTouchListenerImplementor, Xamarin.Android.Support.v7.RecyclerView", RecyclerView_OnItemTouchListenerImplementor.class, __md_methods);
    }
