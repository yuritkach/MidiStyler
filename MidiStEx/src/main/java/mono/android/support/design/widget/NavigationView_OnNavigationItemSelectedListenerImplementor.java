...
public class NavigationView_OnNavigationItemSelectedListenerImplementor implements IGCUserPeer, NavigationView.OnNavigationItemSelectedListener {
    ...
    static {
        Runtime.register("Android.Support.Design.Widget.NavigationView+IOnNavigationItemSelectedListenerImplementor, Xamarin.Android.Support.Design", NavigationView_OnNavigationItemSelectedListenerImplementor.class, __md_methods);
    }
