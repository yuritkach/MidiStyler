...
public class SwipeDismissBehavior_OnDismissListenerImplementor implements IGCUserPeer, SwipeDismissBehavior.OnDismissListener {
    ...
    static {
        Runtime.register("Android.Support.Design.Widget.SwipeDismissBehavior+IOnDismissListenerImplementor, Xamarin.Android.Support.Design", SwipeDismissBehavior_OnDismissListenerImplementor.class, __md_methods);
    }
